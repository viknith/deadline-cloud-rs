...
class DeadlineApp:
    ...
    def launch(
        ...
        """Spawn the Rust CLI binary and attach to its accessibility tree.

        Launches the deadline binary (found via _deadline_binary()) with the
        given CLI args. This tests the full integration path: Rust CLI →
        Python subprocess → Qt GUI, matching how end users invoke the tool.
        """
